/* ============================================================================
   ...
   إلى مرساةٍ فارغة — وعدٌ بصفحةٍ لا وجودَ لها. (ولا نكتب المرساةَ الفارغةَ
   حرفيًّا هنا: هذا الملفُّ يُدرَج في كلّ صفحة، فيصير التعليقُ تسعًا وعشرين
   نتيجةً كاذبةً في أيّ فحصٍ للروابط الميّتة.) صارت «اسأل عن هذا البرنامج» إلى
